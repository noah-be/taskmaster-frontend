...
//   describe('Actions', () => {
//     describe('login', () => {
//       it('should update state and navigate on successful login', async () => {
//         const mockResponse = {
//           token: 'testToken',
...
//     describe('register', () => {
//       it('should update state, navigate, and close register box on successful registration', async () => {
//         const mockResponse = {
//           token: 'testToken',
//           user: { id: 1, username: 'testUser' }
//         };
...
//     describe('logout', () => {
//       it('should reset state and navigate', () => {
